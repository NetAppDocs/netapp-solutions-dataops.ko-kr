...
summary: NetApp 단일 볼륨 또는 여러 볼륨에서 중복 파일을 찾아달라는 요청을 받았습니다.  NetApp 다음과 같은 솔루션을 제공했습니다. 
---
= 중복 파일
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
NetApp 단일 볼륨 또는 여러 볼륨에서 중복 파일을 찾아달라는 요청을 받았습니다.  NetApp 다음과 같은 솔루션을 제공했습니다.

단일 볼륨의 경우 다음 명령을 실행하세요.
